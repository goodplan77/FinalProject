...
import styles from './styles/PostedPage.module.css'; // CSS 모듈을 임포트합니다.
...
const PostedPage = ({ setUserNo }: LoginUserNoProps) => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8013/banju/board/postedList/${loginUser.userNo}`)
            .then((reponse) => {
                console.log(reponse);
